...
var myGameArea = {
    ...
    start : function() {
        ...
        this.frameNo = 0;
        this.interval = setInterval(updateGameArea, 10);//Run the update game area every 20th millisecond or 50 times per second. This is like fps in a game or movie (50fps)  
...
if(ball.crashWith(goal)){
  myGameArea.stop();
  alert("BUCKETS!! YOU WIN! Advance to Level 3");
}
